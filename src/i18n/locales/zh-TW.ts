export default {
  ...
  specialTask: {
    ...
    webhook: {
      ...
      smtpOptionLabel: 'SMTP 連線設定',
      smtpHost: 'SMTP 伺服器',
      smtpHostPlaceholder: '輸入 SMTP 伺服器地址（如 smtp.gmail.com）',
      smtpPort: '連接埠',
      smtpPortError: '請輸入有效的連接埠號',
      smtpUsername: '使用者名稱',
      smtpUsernamePlaceholder: '輸入 SMTP 使用者名稱（通常為電子郵件地址）',
      smtpPassword: '密碼',
      smtpPasswordPlaceholder: '輸入 SMTP 密碼或應用程式專用密碼',
      smtpFrom: '寄件人',
      smtpFromPlaceholder: '輸入寄件人電子郵件地址',
      smtpTo: '收件人',
      smtpToPlaceholder: '輸入收件人電子郵件地址',
      smtpCustomLabel: '自訂郵件內容',
      smtpCustomDescription: '關閉時使用預設的標題和正文；開啟後可自訂',
      smtpCustomYes: '自訂標題和正文',
      smtpCustomNo: '使用預設內容',
      smtpContentLabel: '郵件內容',
      smtpSubject: '郵件標題',
      smtpSubjectPlaceholder: '輸入郵件標題',
      smtpBody: '郵件正文',
      smtpBodyPlaceholder: '輸入郵件正文',
    },
    killProc: {
      label: '⛔ 結束程序',
      selfLabel: '結束自身程序',
