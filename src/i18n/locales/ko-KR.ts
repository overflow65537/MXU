export default {
  ...
  specialTask: {
    ...
    webhook: {
      ...
      smtpOptionLabel: 'SMTP 연결 설정',
      smtpHost: 'SMTP 서버',
      smtpHostPlaceholder: 'SMTP 서버 주소를 입력하세요 (예: smtp.gmail.com)',
      smtpPort: '포트',
      smtpPortError: '유효한 포트 번호를 입력하세요',
      smtpUsername: '사용자 이름',
      smtpUsernamePlaceholder: 'SMTP 사용자 이름을 입력하세요 (보통 이메일 주소)',
      smtpPassword: '비밀번호',
      smtpPasswordPlaceholder: 'SMTP 비밀번호 또는 앱 전용 비밀번호를 입력하세요',
      smtpFrom: '보내는 사람',
      smtpFromPlaceholder: '보내는 사람 이메일 주소를 입력하세요',
      smtpTo: '받는 사람',
      smtpToPlaceholder: '받는 사람 이메일 주소를 입력하세요',
      smtpCustomLabel: '사용자 정의 이메일 내용',
      smtpCustomDescription: '꺼져 있으면 기본 제목과 본문을 사용합니다. 켜면 사용자 정의 가능',
      smtpCustomYes: '제목과 본문 사용자 정의',
      smtpCustomNo: '기본 내용 사용',
      smtpContentLabel: '이메일 내용',
      smtpSubject: '제목',
      smtpSubjectPlaceholder: '이메일 제목을 입력하세요',
      smtpBody: '본문',
      smtpBodyPlaceholder: '이메일 본문을 입력하세요',
    },
    killProc: {
      label: '⛔ 프로세스 종료',
