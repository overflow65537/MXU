export default {
  ...
  specialTask: {
    ...
    webhook: {
      ...
      smtpOptionLabel: 'SMTP 连接设置',
      smtpHost: 'SMTP 服务器',
      smtpHostPlaceholder: '输入 SMTP 服务器地址（如 smtp.gmail.com）',
      smtpPort: '端口',
      smtpPortError: '请输入有效的端口号',
      smtpUsername: '用户名',
      smtpUsernamePlaceholder: '输入 SMTP 用户名（通常为邮箱地址）',
      smtpPassword: '密码',
      smtpPasswordPlaceholder: '输入 SMTP 密码或应用专用密码',
      smtpFrom: '发件人',
      smtpFromPlaceholder: '输入发件人邮箱地址',
      smtpTo: '收件人',
      smtpToPlaceholder: '输入收件人邮箱地址',
      smtpCustomLabel: '自定义邮件内容',
      smtpCustomDescription: '关闭时使用默认的标题和正文；开启后可自定义',
      smtpCustomYes: '自定义标题和正文',
      smtpCustomNo: '使用默认内容',
      smtpContentLabel: '邮件内容',
      smtpSubject: '邮件标题',
      smtpSubjectPlaceholder: '输入邮件标题',
      smtpBody: '邮件正文',
      smtpBodyPlaceholder: '输入邮件正文',
    },
    killProc: {
      label: '⛔ 结束进程',
      selfLabel: '结束自身进程',
