export default {
  ...
  specialTask: {
    ...
    webhook: {
      ...
      typeLabel: 'Notification Method',
      typeWebhook: 'Webhook',
      typeSmtp: 'SMTP Email',
      optionLabel: 'Request Settings',
      urlLabel: 'Request URL',
      urlPlaceholder: 'Enter full URL (e.g. https://example.com/webhook?key=xxx)',
      smtpOptionLabel: 'SMTP Connection Settings',
      smtpHost: 'SMTP Server',
      smtpHostPlaceholder: 'Enter SMTP server address (e.g. smtp.gmail.com)',
      smtpPort: 'Port',
      smtpPortError: 'Please enter a valid port number',
      smtpUsername: 'Username',
      smtpUsernamePlaceholder: 'Enter SMTP username (usually your email address)',
      smtpPassword: 'Password',
      smtpPasswordPlaceholder: 'Enter SMTP password or app-specific password',
      smtpFrom: 'From',
      smtpFromPlaceholder: 'Enter sender email address',
      smtpTo: 'To',
      smtpToPlaceholder: 'Enter recipient email address',
      smtpCustomLabel: 'Custom Email Content',
      smtpCustomDescription: 'When off, default subject and body are used; enable to customize',
      smtpCustomYes: 'Custom subject and body',
      smtpCustomNo: 'Use default content',
      smtpContentLabel: 'Email Content',
      smtpSubject: 'Subject',
      smtpSubjectPlaceholder: 'Enter email subject',
      smtpBody: 'Body',
      smtpBodyPlaceholder: 'Enter email body',
    },
    killProc: {
      label: '⛔ Kill Process',
      selfLabel: 'Kill Self',
