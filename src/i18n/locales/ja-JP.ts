export default {
  ...
  specialTask: {
    ...
    webhook: {
      ...
      smtpOptionLabel: 'SMTP 接続設定',
      smtpHost: 'SMTP サーバー',
      smtpHostPlaceholder: 'SMTP サーバーアドレスを入力（例：smtp.gmail.com）',
      smtpPort: 'ポート',
      smtpPortError: '有効なポート番号を入力してください',
      smtpUsername: 'ユーザー名',
      smtpUsernamePlaceholder: 'SMTP ユーザー名を入力（通常はメールアドレス）',
      smtpPassword: 'パスワード',
      smtpPasswordPlaceholder: 'SMTP パスワードまたはアプリ専用パスワードを入力',
      smtpFrom: '送信元',
      smtpFromPlaceholder: '送信元のメールアドレスを入力',
      smtpTo: '送信先',
      smtpToPlaceholder: '送信先のメールアドレスを入力',
      smtpCustomLabel: 'カスタムメール内容',
      smtpCustomDescription: 'オフの場合はデフォルトの件名と本文を使用。オンにするとカスタマイズ可能',
      smtpCustomYes: '件名と本文をカスタマイズ',
      smtpCustomNo: 'デフォルト内容を使用',
      smtpContentLabel: 'メール内容',
      smtpSubject: '件名',
      smtpSubjectPlaceholder: 'メールの件名を入力',
      smtpBody: '本文',
      smtpBodyPlaceholder: 'メールの本文を入力',
    },
    killProc: {
      label: '⛔ プロセス終了',
